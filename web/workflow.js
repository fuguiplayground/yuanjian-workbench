...
function insightWorkspace(){
 ...
 return head('需求与营销','先选这次要回答的问题，再逐章查看人群、需求与行动建议。',button('补充调研资料','navigate','arrow','','data-page="research"'))
  +flowNav('insights')+demoNote()+aiProgress()+insightChoices()
